    ...
    <div style={{ flex: 1, minHeight: 0, background: C.bg, padding: "16px 28px 22px",
      ...
      <div style={{ display: "flex", gap: 18, padding: "2px", flex: "none", flexWrap: "wrap" }}>
        <div style={{ flex: "1 1 280px", display: "flex", flexDirection: "column", gap: 5 }}>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <div style={{ position: "relative", flex: 1, minWidth: 0 }}>
              <select value={referenceId || ""} onChange={(e) => onSelectReference(e.target.value || null)} style={selectStyle("var(--stat-2, #b45bff)")}>
        ...
        <div style={{ flex: "1 1 280px", display: "flex", flexDirection: "column", gap: 5 }}>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <div style={{ position: "relative", flex: 1, minWidth: 0 }}>
              <select value={comparisonId} onChange={(e) => onSelectComparison(e.target.value)} style={selectStyle("var(--stat-3, #34c8ff)")}>
